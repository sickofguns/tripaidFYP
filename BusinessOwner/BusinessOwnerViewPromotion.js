...
const BOSpecificPromotionScreen = () => {
  ...
  useEffect(() => {
    ...
    const handleedit = () => {
        navigation.navigate('Business Owner Edit Promotion'); // Navigate to SignUp screen on button press
      };
    ...
    const itineraryData = [
        {
          title: 'Student Deal',
          description: "Bring your student pass to us and enjoy a 50% off!      Not valid on weekends and public holidays.",
          imageUrl: require('../assets/students.jpg'),
        },
