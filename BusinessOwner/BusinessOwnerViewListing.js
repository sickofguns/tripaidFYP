    ...
    const itineraryData = [
        {
          ...
          description: "Experience what it's like to skydive without the dangers and cost of doing a tandem jump! iFly introduces the new sport of bodyflying, where participants are given the chance to hover and 'fly' inside the world's first themed wind tunnel. With patented technology, the 16.5ft-wide, five storey-high tunnel propels flyers through powerful airspeeds, replicating the jump experienced from a plane. You will receive training from professional instructors and get suited up in sky diving gear before doing your jump, ensuring that safety grounds are covered before entering the tunnel and experiencing the rush of a sky dive!",
          imageUrl: require('../assets/ifly2.jpg'),
        },
