...
const BOPromotionScreen = () => {
  ...
  useEffect(() => {
    ...
    const handleViewContent = () => {
      navigation.navigate('Business Owner View Promotion');
    };
    ...
    const itineraryData = [
        {
          ...
          imageUrl: require('../assets/iflystudent.jpg'),
        ...
        },
        {
          ...
          },
          {
            ...
            imageUrl: require('../assets/2for1.jpg'),
              ...
              {/* Account Information */}
                    <View style={styles.accountInfo}>
                        <View style={styles.accountTextContainer}>
                            ...
                            <Text style={[styles.mainText, {color : '#FB7E3C' }]}>Promotions</Text>
                        </View>
