  ...
  const handleupdate = async () => {
    ...
    try {
      if (!promotion || !title || !thumbnail || !description) {
        alert("Please fill in all required fields (Title, Image, Promotion Details and Code) before updating.");
        return;
      }
      ...
      <View style={styles.midContainer}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.promoContainer}>
            <Text style={styles.promoText}>Add promotion</Text>
            <View style={styles.promoInputContainer}>
              <TextInput
                style={styles.promoInput}
                placeholder="Enter promo code"
                value={promotion} // Use location if set, otherwise use currentLocation
