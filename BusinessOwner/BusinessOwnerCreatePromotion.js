...
const BOCreatePromotion = () => {
  ...
  const handlepublish = async () => {
    ...
    const docR = await addDoc(promoCollection, promoData);
    const promoref = doc(promoCollection, docR.id);

    await updateDoc(promoref, { id: docR.id })
    // Show alert on publishing itinerary
    alert("Promotion created!");
    navigation.navigate("Business Owner"); // Navigate to LOL More screen after publishing
  };
