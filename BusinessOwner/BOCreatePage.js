...
const BOCreateMainScreen = () => {
  ...
  useEffect(() => {
    ...
    const handleListing = () => {
        navigation.navigate('Business Owner Listing');
    }
   

    const handlePromo = () => {
        navigation.navigate('Business Owner Create Promotion');
    }
          ...
          <View style={styles.logoheader}>
            ...
            <View style={styles.midContainer}>
              ...
              <Text style={styles.selectText}>What's on your mind?</Text>
                ...
                <TouchableOpacity onPress={() => handleListing()} style={[styles.curvedContainer]}>        
                <View>
                    <Image
                    source={require('../assets/listing.jpg')}
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Listing</Text>
                </View>
                </TouchableOpacity>
                ...
                <View>
                    ...
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Promotion</Text>
                </View>
                </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    image: {
      ...
      textBehindImage: {
        ...
        textAlign: 'center',
        width: '100%',
        marginTop: 40, // Adjust the positioning of the text as needed
      },
    selectText: {
        color: '#0A2753',
        fontSize: 32,
...
export default BOCreateMainScreen;