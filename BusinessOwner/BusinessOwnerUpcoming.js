...
const BOUpcoming = () => {
  ...
  useEffect(() => {
    ...
    const handleViewContent = () => {
      navigation.navigate('Upcoming Listing');
    };
    ...
    const handlecreatelisting = () => {
      navigation.navigate('Business Owner Listing'); // Navigate to SignUp screen on button press
    };
    ...
    const upcomingData = [
        {
          ...
          description: "Bring your partner this valentines day and receive a surprise!",
          imageUrl: require('../assets/iflyvalentines.jpg'),
        },
        {
            title: 'iFlyandZoo',
            description: "For those who love animals and want to experience flying!",
            imageUrl: require('../assets/zooifly.jpg'),
          },
          {
            title: 'iFlyandNature',
            description: "For those who love nature and want to experience flying!",
            imageUrl: require('../assets/nature.jpg'),
          },
    ...
    return (
        <View style={styles.container}>
              ...
              {/* Account Information */}
                    <View style={styles.accountInfo}>
                        <View style={styles.accountTextContainer}>
                            ...
                            <Text style={[styles.mainText, {color : '#FB7E3C' }]}>Listings</Text>
                        </View>
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                   ...
                   {/* Mapping through upcomingData array */}
