  ...
  const handleupdate = async () => {
    ...
    try {
      if (!title || !thumbnail || !description) {
        alert("Please fill in all required fields (Title, Image and Description) before updating.");
        return;
      }
      // Update the review in the database
      await updateDoc(doc(db, 'listings', listing.id), updatedListing);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.midContainer}>
        ...
        <TouchableOpacity style={styles.createButton} onPress={handleupdate}>
          <Text style={styles.createButtonText}>Update Listing</Text>
        </TouchableOpacity>
