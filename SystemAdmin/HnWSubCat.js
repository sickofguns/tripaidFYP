...
const SubCategoryHNWScreen = () => {
    const navigation = useNavigation(); // Initialize the navigation object

    const subcategories = [
      { id: 1, image: require('../assets/fitness.jpg'), category: 'Fitness Centers' },
      { id: 2, image: require('../assets/wellness.jpg'), category: 'Wellness and Spa' },
      { id: 3, image: require('../assets/massage.jpg'), category: 'Massage' },
      { id: 4, image: require('../assets/pharmacy.jpg'), category: 'Pharmacies' },
      { id: 5, image: require('../assets/healthcare.jpg'), category: 'Healthcare' },
    ];
...
export default SubCategoryHNWScreen;