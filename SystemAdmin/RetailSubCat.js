...
const SubCategoryRetailScreen = () => {
    const navigation = useNavigation(); // Initialize the navigation object

    const subcategories = [
      { id: 1, image: require('../assets/fashions.jpg'), category: 'Fashion' },
      { id: 2, image: require('../assets/beauty.jpg'), category: 'Beauty' },
      { id: 3, image: require('../assets/IT.jpg'), category: 'IT' },
    ];
...
export default SubCategoryRetailScreen;