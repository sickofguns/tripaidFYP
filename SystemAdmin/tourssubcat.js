...
const SubCategoryToursScreen = () => {
    const navigation = useNavigation(); // Initialize the navigation object

    const subcategories = [
      { id: 1, image: require('../assets/workshops.jpg'), category: 'Workshops' },
      { id: 2, image: require('../assets/heritage.jpg'), category: 'Heritage Tours' },
      { id: 3, image: require('../assets/citytour.jpg'), category: 'City Tours' },
      { id: 4, image: require('../assets/food.jpg'), category: 'Food Tours' },
      { id: 5, image: require('../assets/tour.jpg'), category: 'Boat Tours' },
      { id: 6, image: require('../assets/historical.jpg'), category: 'Historic Tours' },
    ];
...
export default SubCategoryToursScreen;