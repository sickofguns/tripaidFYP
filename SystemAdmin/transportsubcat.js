...
const SubCategoryTransportScreen = () => {
    const navigation = useNavigation(); // Initialize the navigation object

    const subcategories = [
      { id: 1, image: require('../assets/carrental.jpg'), category: 'Car Rental' },
      { id: 2, image: require('../assets/airportlimo.jpg'), category: 'Airport Limousine' },
    ];
...
export default SubCategoryTransportScreen;