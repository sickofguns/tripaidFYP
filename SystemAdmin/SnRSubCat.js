...
const SubCategorySnRScreen = () => {
    const navigation = useNavigation(); // Initialize the navigation object

    const subcategories = [
      { id: 1, image: require('../assets/zoo.jpg'), category: 'Attractions' },
      { id: 2, image: require('../assets/watersports.jpg'), category: 'Water Sports' },
      { id: 3, image: require('../assets/landtours.jpg'), category: 'Land Tours' },
      { id: 4, image: require('../assets/ES.jpg'), category: 'Extreme Sports' },
      { id: 5, image: require('../assets/ODAC.jpg'), category: 'Outdoor Adventures' },
      { id: 6, image: require('../assets/camping.jpg'), category: 'Camping' },
    ];
...
export default SubCategorySnRScreen;