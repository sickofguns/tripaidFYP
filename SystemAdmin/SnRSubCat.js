    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.midContainer}>
                ...
                <View style={styles.curvedContainer}>
                    <Image
                    source={require('../assets/watersports.jpg')}
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Water Sports</Text>
                </View>

                <View style={styles.curvedContainer}>
                    <Image
                    source={require('../assets/landtours.jpg')}
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Land Tours</Text>
                </View>
