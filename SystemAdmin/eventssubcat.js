...
const SubCategoryEventsScreen = () => {
    const navigation = useNavigation(); // Initialize the navigation object

    const subcategories = [
      { id: 1, image: require('../assets/concert.jpg'), category: 'Concert' },
      { id: 2, image: require('../assets/musical.jpg'), category: 'Musical' },
      { id: 3, image: require('../assets/match.jpg'), category: 'Competition' },
    ];
...
export default SubCategoryEventsScreen;