    ...
    try {
        ...
        querySnapshot.forEach((doc) => {
            ...
            const formattedListing = {
                ...
                imageUrl: require("../assets/error.jpg") || listingData.thumbnail,
  ...
  try {
      ...
      querySnapshot.forEach((doc) => {
          ...
          const formattedPromo = {
              id: doc.id, // Use the document ID as the post ID
              imageUrl: require("../assets/error.jpg") || promoData.thumbnail,
              pfp: require("../assets/pfp.png"),
              username: promoData.username,
              timeposted: formatTimestamp(promoData.created),
              location: promoData.location,
              caption: promoData.description,
              likes: promoData.likes,
              comments: promoData.comments || [], // Use an empty array if comments field is missing
          };
...
/////////////////////////////////////////////////////////////////////////////
  ...
  const handleViewPromo = (promo) => {
    navigation.navigate('User Promo', { promo });
  };
              ...
              <View key={promo.id} style={styles.promosTopLine}> 
                <View style={styles.promosContent}>
                  <View style={styles.promosColumn}>
                    ...
                    <Text style={styles.promosSubtitle}>{promo.subtitle}</Text>
                  ...
                  <View style={styles.promosColumn}>
                    <Image source={promo.imageSource} style={styles.promosImage} />
                  </View>
                </View>
              </View>
            ))}
...
export default BOUserProfilePage;
