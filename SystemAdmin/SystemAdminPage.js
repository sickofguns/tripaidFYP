...
const SystemAdminScreen = () => {
    ...
    const usage = [
      ...
      { nuCount: 200, avgUsageTime: 6.0 },
      { nuCount: 300, avgUsageTime: 2.0 },
      { nuCount: 200, avgUsageTime: 9.0 },
      { nuCount: 300, avgUsageTime: 7.0 },
      { nuCount: 100, avgUsageTime: 3.5 },
      { nuCount: 200, avgUsageTime: 3.0 },
      { nuCount: 300, avgUsageTime: 8.0 },
      { nuCount: 200, avgUsageTime: 1.0 },
      { nuCount: 300, avgUsageTime: 2.0 },
      { nuCount: 100, avgUsageTime: 5.5 },
      { nuCount: 200, avgUsageTime: 7.0 },
      { nuCount: 300, avgUsageTime: 2.0 },
      { nuCount: 200, avgUsageTime: 6.0 },
      { nuCount: 300, avgUsageTime: 2.0 },
      { nuCount: 100, avgUsageTime: 4.5 },
      { nuCount: 200, avgUsageTime: 3.0 },
      { nuCount: 300, avgUsageTime: 8.0 },
      { nuCount: 200, avgUsageTime: 3.0 },
      { nuCount: 300, avgUsageTime: 9.0 },
            ...
            {/* NU Insights Bar */}
              <View style={styles.rowContainer}>
                  ...
                  <View style={styles.leftColumn}>
                      ...
                      <View style={styles.columnItem}>
                          <Text style={styles.columnTextLarge}>{averagePerDay} Hours</Text>
                      </View>
                  </View>
