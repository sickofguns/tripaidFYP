...
const SubCategoryFnbScreen = () => {
    const navigation = useNavigation(); // Initialize the navigation object

    const subcategories = [
      { id: 1, image: require('../assets/Hawker.jpg'), category: 'Hawker Centres' },
      { id: 2, image: require('../assets/Restaurants.jpg'), category: 'Restaurants' },
      { id: 3, image: require('../assets/Cafe.jpg'), category: 'Cafe' },
      { id: 4, image: require('../assets/Bar.jpg'), category: 'Bars' },
      { id: 5, image: require('../assets/FD.jpg'), category: 'Fine Dining' },
      { id: 6, image: require('../assets/buffet.jpg'), category: 'Buffet' },
    ];
...
export default SubCategoryFnbScreen;