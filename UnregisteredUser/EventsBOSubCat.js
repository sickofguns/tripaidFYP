...
const BOSubCategoryEventsScreen = ({ route }) => {
    ...
    const subcategories = [
      { id: 1, onPress: handlePress, image: require('../assets/concert.jpg'), category: 'Concert' },
      { id: 2, onPress: handlePress, image: require('../assets/musical.jpg'), category: 'Musical' },
      { id: 3, onPress: handlePress, image: require('../assets/match.jpg'), category: 'Competition' },
    ];
