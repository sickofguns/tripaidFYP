...
const BOSubCategoryEventsScreen = ({ route }) => {
    ...
    const navigateToSubBusiness = (subcategory) => {
      ...
      } else if (subcategory === 'Musical') {
        navigation.navigate('Account Successfully Registered', { userId });
      } else if (subcategory === 'Competition') {
        navigation.navigate('Account Successfully Registered', { userId });
      }
        };
    ...
    const subcategories = [
      { id: 1, onPress: () => handlePress('Concert'), image: require('../assets/concert.jpg'), category: 'Concert' },
      { id: 2, onPress: () => handlePress('Musical'), image: require('../assets/musical.jpg'), category: 'Musical' },
      { id: 3, onPress: () => handlePress('Competition'), image: require('../assets/match.jpg'), category: 'Competition' },
    ];
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.midContainer}>
                ...
                <Text style={styles.selectText}>Events & Shows {'\n'} Sub-Business</Text>
...
export default BOSubCategoryEventsScreen;