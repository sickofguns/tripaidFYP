...
const BOSubCategorySnRScreen = ({ route }) => {
    ...
    const navigateToSubBusiness = (subcategory) => {
      if (subcategory === 'Attractions') {
        navigation.navigate('Account Successfully Registered', { userId });
      } else if (subcategory === 'Water Sports') {
        navigation.navigate('Account Successfully Registered', { userId });
      } else if (subcategory === 'Land Tours') {
        navigation.navigate('Account Successfully Registered', { userId });
      }else if (subcategory === 'Extreme Sports') {
        navigation.navigate('Account Successfully Registered', { userId });
      } else if (subcategory === 'Outdoor Adventures') {
        navigation.navigate('Account Successfully Registered', { userId });
      }else if (subcategory === 'Camping') {
        navigation.navigate('Account Successfully Registered', { userId });
      } 
        };
    ...
    const subcategories = [
      { id: 1, onPress: () => handlePress('Attractions'), image: require('../assets/zoo.jpg'), category: 'Attractions' },
      { id: 2, onPress: () => handlePress('Water Sports'), image: require('../assets/watersports.jpg'), category: 'Water Sports' },
      { id: 3, onPress: () => handlePress('Land Tours'), image: require('../assets/landtours.jpg'), category: 'Land Tours' },
      { id: 4, onPress: () => handlePress('Extreme Sports'), image: require('../assets/ES.jpg'), category: 'Extreme Sports' },
      { id: 5, onPress: () => handlePress('Outdoor Adventures'), image: require('../assets/ODAC.jpg'), category: 'Outdoor Adventures' },
      { id: 6, onPress: () => handlePress('Camping'), image: require('../assets/camping.jpg'), category: 'Camping' },
    ];
