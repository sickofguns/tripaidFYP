...
const BORegistrationScreen = () => {
    ...
    const hour = [
        "9 AM - 5 PM", "10 AM - 6 PM", "8:30 AM - 4:30 PM", "11 AM - 7 PM", "9:30 AM - 5:30 PM",
        "12 PM - 8 PM", "1 PM - 9 PM", "8 AM - 4 PM", "10:30 AM - 6:30 PM", "11:30 AM - 7:30 PM", "24 Hours"
    ];
    const hostsize = [
        "Small (1-20 guests)", "Medium (20-50 guests)", "Large (50-100 guests)", "Extra Large (100+ guests)",
        "Intimate (1-10 guests)", "Intimate Gathering (1-15 guests)", "Cozy (10-30 guests)",
        "Spacious (30-70 guests)", "Grand (70-150 guests)", "Massive (150+ guests)"
    ];
    ...
    const handleContinuePress = () => {
        ...
        navigation.navigate('Business Registration Category');
    };
        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.midContainer}>
                    ...
                    <Text style={styles.enterDOBText}>Select your Business Category</Text>
                    <View style={styles.dropdownContainer}>
                        <Picker
