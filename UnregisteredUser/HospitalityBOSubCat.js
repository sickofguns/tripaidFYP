...
const BOSubCategoryHospitalityScreen = ({ route }) => {
    ...
    const subcategories = [
      { id: 1, onPress: handlePress, image: require('../assets/hotel.jpg'), category: 'Hotels' },
      { id: 2, onPress: handlePress, image: require('../assets/countryclub.jpg'), category: 'Country Clubs' },
      { id: 3, onPress: handlePress, image: require('../assets/hospitality.jpg'), category: 'Airbnb / HomeStay' },
      { id: 4, onPress: handlePress, image: require('../assets/resorts.jpg'), category: 'Resorts' },
      { id: 5, onPress: handlePress, image: require('../assets/agency.jpg'), category: 'Travel Agencies' },
    ];
