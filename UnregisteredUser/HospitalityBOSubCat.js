        ...
        <View style={styles.container}>
            ...
            <View style={styles.midContainer}>
                ...
                <View style={styles.curvedContainer}>
                    ...
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Hotels</Text>
                </View>
                </TouchableOpacity>
                ...
                <View style={styles.curvedContainer}>
                    <Image
                    source={require('../assets/countryclub.jpg')}
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Country Clubs</Text>
                </View>
                </TouchableOpacity>
                ...
                <View style={styles.curvedContainer}>
                    ...
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Airbnb / HomeStay</Text>
                </View>
                </TouchableOpacity>
