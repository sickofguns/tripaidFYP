...
const BOSubCategoryHospitalityScreen = ({ route }) => {
    ...
    const navigateToSubBusiness = (subcategory) => {
      ...
      } else if (subcategory === 'Country Clubs') {
        navigation.navigate('Account Successfully Registered', { userId });
      } else if (subcategory === 'Airbnb / HomeStay') {
        navigation.navigate('Account Successfully Registered', { userId });
      }else if (subcategory === 'Resorts') {
        navigation.navigate('Account Successfully Registered', { userId });
      }else if (subcategory === 'Travel Agencies') {
        navigation.navigate('Account Successfully Registered', { userId });
      }
        };
    ...
    const subcategories = [
      { id: 1, onPress: () => handlePress('Hotels'), image: require('../assets/hotel.jpg'), category: 'Hotels' },
      { id: 2, onPress: () => handlePress('Country Clubs'), image: require('../assets/countryclub.jpg'), category: 'Country Clubs' },
      { id: 3, onPress: () => handlePress('Airbnb / HomeStay'), image: require('../assets/hospitality.jpg'), category: 'Airbnb / HomeStay' },
      { id: 4, onPress: () => handlePress('Resorts'), image: require('../assets/resorts.jpg'), category: 'Resorts' },
      { id: 5, onPress: () => handlePress('Travel Agencies'), image: require('../assets/agency.jpg'), category: 'Travel Agencies' },
    ];
...
export default BOSubCategoryHospitalityScreen;