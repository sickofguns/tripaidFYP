...
const BOSubCategoryToursScreen = ({ route }) => {
    ...
    const subcategories = [
      { id: 1, onPress: handlePress, image: require('../assets/workshops.jpg'), category: 'Workshops' },
      { id: 2, onPress: handlePress, image: require('../assets/heritage.jpg'), category: 'Heritage Tours' },
      { id: 3, onPress: handlePress, image: require('../assets/citytour.jpg'), category: 'City Tours' },
      { id: 4, onPress: handlePress, image: require('../assets/food.jpg'), category: 'Food Tours' },
      { id: 5, onPress: handlePress, image: require('../assets/tour.jpg'), category: 'Boat Tours' },
      { id: 6, onPress: handlePress, image: require('../assets/historical.jpg'), category: 'Historic Tours' },
    ];
