...
const BOSubCategoryFnbScreen = () => {
    ...
    const subcategories = [
      { id: 1, onPress: handlePress, image: require('../assets/Hawker.jpg'), category: 'Hawker Centres' },
      { id: 2, onPress: handlePress, image: require('../assets/Restaurants.jpg'), category: 'Restaurants' },
      { id: 3, onPress: handlePress, image: require('../assets/Cafe.jpg'), category: 'Cafe' },
      { id: 4, onPress: handlePress, image: require('../assets/Bar.jpg'), category: 'Bars' },
    ];
