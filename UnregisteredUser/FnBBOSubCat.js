        ...
        <View style={styles.container}>
            ...
            <View style={styles.midContainer}>
                ...
                <View style={styles.curvedContainer}>
                    <Image
                    source={require('../assets/Hawker.jpg')}
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Hawker Centres</Text>
                </View>
                </TouchableOpacity>
                ...
                <View style={styles.curvedContainer}>
                    ...
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Restaurants</Text>
                </View>
                </TouchableOpacity>
                ...
                <View style={styles.curvedContainer}>
                    ...
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Cafe</Text>
                </View>
                </TouchableOpacity>
                ...
                <View style={styles.curvedContainer}>
                    ...
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Bars</Text>
                </View>
                </TouchableOpacity>
