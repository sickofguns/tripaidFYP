...
const BOCategoryScreen = ({ route }) => {
    ...
    const handlePressHospitality = () => {
        navigation.navigate('Business Registration SubCategory - Hospitality', { userId }); // Navigate to SignUp screen on button press
    };
    const handlePressFNB = () => {
      navigation.navigate('Business Registration SubCategory - Food & Beverage', { userId }); // Navigate to SignUp screen on button press
    };
    const handlePressSNR = () => {
      navigation.navigate('Business Registration SubCategory - Sports & Recreation', { userId }); // Navigate to SignUp screen on button press
    };
    const handlePressRetail = () => {
      navigation.navigate('Business Registration SubCategory - Retail', { userId }); // Navigate to SignUp screen on button press
    };
    const handlePressHNW = () => {
      navigation.navigate('Business Registration SubCategory - Health & Wellness', { userId }); // Navigate to SignUp screen on button press
  };
  const handlePressTransport = () => {
    navigation.navigate('Business Registration SubCategory - Transport', { userId }); // Navigate to SignUp screen on button press
  };
  const handlePressTOURS = () => {
    navigation.navigate('Business Registration SubCategory - Tours & Experiences', { userId }); // Navigate to SignUp screen on button press
  };
  const handlePressEvents = () => {
    navigation.navigate('Business Registration SubCategory - Events & Shows', { userId }); // Navigate to SignUp screen on button press
  };
