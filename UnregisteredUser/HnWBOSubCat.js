...
const BOSubCategoryHnWScreen = ({ route }) => {
    ...
    const subcategories = [
      { id: 1, onPress: handlePress, image: require('../assets/fitness.jpg'), category: 'Fitness Centers' },
      { id: 2, onPress: handlePress, image: require('../assets/wellness.jpg'), category: 'Wellness and Spa' },
      { id: 3, onPress: handlePress, image: require('../assets/massage.jpg'), category: 'Massage' },
      { id: 4, onPress: handlePress, image: require('../assets/pharmacy.jpg'), category: 'Pharmacies' },
      { id: 5, onPress: handlePress, image: require('../assets/healthcare.jpg'), category: 'Healthcare' },
    ];
