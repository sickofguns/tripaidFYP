...
const BOSubCategoryTransportScreen = ({ route }) => {
    ...
    const subcategories = [
      { id: 1, onPress: handlePress, image: require('../assets/carrental.jpg'), category: 'Car Rental' },
      { id: 2, onPress: handlePress, image: require('../assets/airportlimo.jpg'), category: 'Airport Limousine' },
    ];
