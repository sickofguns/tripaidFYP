...
const BOSubCategoryTransportScreen = ({ route }) => {
    ...
    const navigateToSubBusiness = (subcategory) => {
      if (subcategory === 'Car Rental') {
        navigation.navigate('Account Successfully Registered', { userId });
      } else if (subcategory === 'Airport Limousine') {
        navigation.navigate('Account Successfully Registered', { userId });
      } 
        };

    const subcategories = [
      { id: 1, onPress: () => handlePress('Car Rental'), image: require('../assets/carrental.jpg'), category: 'Car Rental' },
      { id: 2, onPress: () => handlePress('Airport Limousine'), image: require('../assets/airportlimo.jpg'), category: 'Airport Limousine' },
    ];
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.midContainer}>
                ...
                <Text style={styles.selectText}>Transport {'\n'} Sub-Business</Text>
...
export default BOSubCategoryTransportScreen;