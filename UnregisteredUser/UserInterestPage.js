...
const UserInterestScreen = ({route}) => {
  ...
  useEffect(() => {
    ...
    const [isFoodSelected, setIsFoodSelected] = useState(false); // Track Food selection state
    const [isAttractionsSelected, setIsAttractionsSelected] = useState(false); // Track Food selection state
    const [isTrailsSelected, setIsTrailsSelected] = useState(false); // Track Food selection state
    const [isLifestyleSelected, setIsLifestyleSelected] = useState(false); // Track Food selection state
    const [isFashionSelected, setIsFashionSelected] = useState(false); // Track Food selection state
