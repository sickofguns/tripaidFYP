...
const BOSubCategoryRetailScreen = () => {
    ...
    const subcategories = [
      { id: 1, onPress: handlePress, image: require('../assets/fashions.jpg'), category: 'Fashion' },
      { id: 2, onPress: handlePress, image: require('../assets/beauty.jpg'), category: 'Beauty' },
    ];
