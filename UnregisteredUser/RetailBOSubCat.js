...
const BOSubCategoryRetailScreen = ({ route }) => {
    ...
    const navigateToSubBusiness = (subcategory) => {
      if (subcategory === 'Fashion') {
        ...
        navigation.navigate('Account Successfully Registered', { userId });
      } else if (subcategory === 'IT') {
        navigation.navigate('Account Successfully Registered', { userId });
      }
        };

    const subcategories = [
      { id: 1, onPress: () => handlePress('Fashion'), image: require('../assets/fashions.jpg'), category: 'Fashion' },
      { id: 2, onPress: () => handlePress('Beauty'), image: require('../assets/beauty.jpg'), category: 'Beauty' },
      { id: 3, onPress: () => handlePress('IT'), image: require('../assets/IT.jpg'), category: 'IT' },
    ];
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.midContainer}>
                ...
                <Text style={styles.selectText}>Retail {'\n'} Sub-Business</Text>
...
export default BOSubCategoryRetailScreen;