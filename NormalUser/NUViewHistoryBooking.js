...
function formatTime(seconds, nanoseconds) {
  ...
  const formattedString = date.toDateString();

  return formattedString;
}

const NUSpecificHistoryBookingScreen = () => {
            ...
            <View>
              {bookingData.category === "food" && (
                <Text style={styles.categoryText}>
                  Restaurant Reservation at {bookingData.location}
                </Text>
              )}
              {bookingData.category === "attraction" && (
                <Text style={styles.categoryText}>
                  Activity Reservation at {bookingData.location}
                </Text>
              )}
              {bookingData.category === "accommodation" && (
                <Text style={styles.categoryText}>
                  Accommodation Reservation at {bookingData.location}
                </Text>
              )}
              <Text style={styles.detailText}>
                ...
                <Text style={styles.boldBlack}>
                  {formatTime(
                    bookingData.checkin.seconds,
                    bookingData.checkin.nanoseconds
                  )}
                </Text>
              </Text>
              <Text style={styles.detailText}>
                ...
                <Text style={styles.boldBlack}>
                  {formatTime(
                    bookingData.checkoutdate.seconds,
                    bookingData.checkoutdate.nanoseconds
                  )}
                </Text>
              </Text>
              <Text style={styles.detailText}>
                Location:{" "}
                <Text style={styles.boldBlack}>{bookingData.location}</Text>
              </Text>
              <Text style={styles.detailText}>
                BookingID:{" "}
                <Text style={styles.boldBlack}>{bookingData.id}</Text>
              </Text>
              <Text style={styles.detailText}>
                Details:
                <Text style={styles.boldBlack}>{bookingData.remark}</Text>
              </Text>
              <Text style={styles.boldBlack}>{bookingData.adult}</Text>
              <Text style={styles.boldBlack}>{bookingData.children}</Text>
            </View>
          )}
        </ScrollView>
...
export default NUSpecificHistoryBookingScreen;
