    ...
    if (isValidPromo(promo)) {
      ...
      try {
        ...
        if (!selectedTransport || !place || !checkindate || !checkoutdate || !adults || !time ) {
          ...
          setSelectedTransportError(!selectedTransport);
          setPlaceError(!place);
        ...
        console.log("Car Seat Needed:", carSeatNeeded); // Log car seat information
        ...
        const bookData = {
          ...
          create: new Date(),
          userId: user.id,
          carSeatNeeded, // Include car seat information
        };
