  ...
  useEffect(() => {
    ...
    fetchLocation();
      ...
      const handleProceed = async () => {
        ...
        // Display custom alert with input field
        Alert.prompt(
          'Enter Email Address',
              ...
              onPress: async (enteredEmail) => {
                if (isValidEmail(enteredEmail)) {
                  try {
                    ...
                    // Update the email address in the Firestore database
          ...
          'plain-text', // Use 'plain-text' for a text input field
          '',
          'email-address' // Specify the keyboard type for email address input
        );
      };
