...
const NUBookingPaymentScreen = () => {
  ...
  useEffect(() => {
    ...
    const handlebooking = () => {
        ...
        navigation.navigate('Normal User Booking Confirmation Page'); // Navigate to Normal User More screen after publishing
      };
...
export default NUBookingPaymentScreen;