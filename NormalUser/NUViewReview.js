...
const NUSpecificReviewScreen = ({ route }) => {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////edit 
    const handleedit = (review) => {
        navigation.navigate('Normal User Edit Review', { review } ); // Navigate to SignUp screen on button press
      };
////////////////////////////////////////////////////////////////////////////////////////////////////////////delete
        ...
        <View style={styles.container}>
          ...
          {user.pfp ? (
              ...
              />
                            ...
                            <View key={index}>
                                ...
                                {(item.reply &&(
                                    <View style={styles.replyContainer}>
                                        <Text style={styles.replyText}>{item.business}:</Text>
                ...
                <TouchableOpacity style={styles.createButton} onPress={() => handleedit(review)}>

                <Text style={styles.createButtonText}>Edit Review</Text>
                </TouchableOpacity>
...
export default NUSpecificReviewScreen;