...
const NUSpecificReviewScreen = () => {
  ...
  useEffect(() => {
    ...
    const handleedit = () => {
        navigation.navigate('Normal User Edit Review'); // Navigate to SignUp screen on button press
      };
                        ...
                        {reviews.map((item, index) => (
                            <View key={index}>
                                ...
                                <View style={styles.titleContainer}>
                                    ...
                                    <Text style={styles.subtitle}>{item.business}</Text>
                                </View>
