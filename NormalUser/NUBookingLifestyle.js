...
const NULifestyleBookingScreen = () => {
  ...
  const handlebooking = async () => {
    ...
    if (!selectedLifestyle || !place || !checkindate || !checkoutdate || !adults || !rooms) {
      // If any required field is empty, set error flags
      setSelectedLifestyleError(!selectedLifestyle);
      setPlaceError(!place);
    ...
    if (isValidPromo(promo)) {
      // Promo is valid, you can proceed with your logic
...
export default NULifestyleBookingScreen;
