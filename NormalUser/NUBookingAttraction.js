...
const NUAttractionBookingScreen = () => {
  ...
  const accommodations = [
    ...
    {
      label: "Holiday Inn Express @ Orchard",
      value: "Holiday Inn Express, Orchard",
    },
    { label: "Holiday Inn @ Little India", value: "Holiday Inn, Little India" },
    {
      label: "Park Royal Collection @ Marina Bay",
      value: "Park Royal Collection, Marina Bay",
    },
    {
      label: "Park Royal Collection @ Pickering",
      value: "Park Royal Collection, Pickering",
    },
    {
      label: "Park Royal Collection @ Beach Road",
      value: "Park Royal Collection, Beach Road",
    },
  ...
  const handlebooking = async () => {
    if (isValidPromo(promo)) {
      ...
      try {
        ...
        alert("Book!");
        navigation.navigate("Normal User Booking Payment Page");
      } catch (error) {
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <View style={styles.titleContainer}>
            ...
            <View style={styles.inputContainer}>
              ...
              >
                <Picker.Item label="Select Attraction" value="Accommodation" />
