...
const NUSpecificItineraryScreen = ({ route }) => {
  ...
  const handleedit = () => {
    navigation.navigate("Normal User Edit Itinerary", { itinerary }); // Navigate to SignUp screen on button press
  };
...
export default NUSpecificItineraryScreen;
