...
const ViewNUUserProfilePage = ({ route }) => {
  ...
  const handleFollowPress = () => {
    ...
    // You can add logic here to handle the follow action (e.g., send a request to the server)
  };
    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <TouchableOpacity
          ...
          style={[
            styles.followButton,
            { backgroundColor: isFollowing ? '#030D45' : '#FB7E3C', color: isFollowing ? 'black' : 'white' },
          ]}
        >
...
export default ViewNUUserProfilePage;
