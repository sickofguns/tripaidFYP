...
const SettingsScreen = () => {
  ...
  const handleChangePhone = () => {
    // Implement your logic to change the phone
    Alert.alert('Phone Number Changed', 'Your phone number has been updated.');
  };

  const handleChangeBio = () => {
    // Implement your logic to change the bio
    Alert.alert('Bio Changed', 'Your bio has been updated.');
  };
        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.contentContainer}>
                <View style={styles.midContainer}>
                    ...
                    <Text style={styles.titletext}>Change Bio: </Text>
