...
const LOLSpecificTrailScreen = () => {
  ...
  useEffect(() => {
    ...
    const handleedit = () => {
        navigation.navigate('LOL Edit Trail'); // Navigate to SignUp screen on button press
      };
        ...
        <View style={styles.container}>
            ...
            <Image source={require('../assets/LOGO.png')} style={styles.logo} />
              ...
              {/* Account Information */}
                ...
                <Text style={styles.createButtonText}>Edit Trail</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.createButton} onPress={handledelete}>
                <Text style={styles.createButtonText}>Delete Trail</Text>
                </TouchableOpacity>
...
export default LOLSpecificTrailScreen;