...
const LOLCreateItineraryScreen = () => {
  ...
  useEffect(() => {
    ...
    const handlepublish = () => {
        ...
        navigation.navigate('LOL Itinerary'); // Navigate to LOL More screen after publishing
      };
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.Detailscontainer}>
                ...
                <Text style={styles.createButtonText}>Save Itinerary</Text>
                </TouchableOpacity>
...
export default LOLCreateItineraryScreen;