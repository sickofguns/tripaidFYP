    ...
    const handleCreate = () => {
      ...
      const handlepublish = async () => {
        try {
          ...
          const trailCollection = collection(db, "trails"); // Replace 'db' with your Firestore database reference
          await addDoc(trailCollection, newTrail);
    
          // Show alert on successful publishing
          alert("Trail published!");
        ...
        <View style={styles.container}>
          ...
          <View style={styles.titleContainer}>
            ...
            <View style={styles.Detailscontainer}>
                ...
                <Text style={styles.createButtonText}>Publish Trail</Text>
                </TouchableOpacity>
...
export default LOLCreateTrailScreen;