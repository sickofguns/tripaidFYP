...
const LOLEventsBookingScreen = () => {
  ...
  const handlebooking = async () => {
    ...
    if (!selectedEvent || !place || !checkindate || !checkoutdate || !adults ) {
      ...
      try {
        ...
        userQuerySnapshot.forEach((doc) => {
          ...
          if (userData.username === selectedEvent) {
...
export default LOLEventsBookingScreen;
