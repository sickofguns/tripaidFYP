...
const LOLFnBBookingScreen = () => {
    ...
    const [selectedAccommodation, setSelectedAccommodation] = useState('Select Fnb');
...
export default LOLFnBBookingScreen;