...
const LOLAttractionBookingScreen = () => {
    ...
    const [selectedAccommodation, setSelectedAccommodation] = useState('Select Attraction');
    ...
    const handlebooking = () => {
        ...
        alert('Attraction booked!');
        navigation.navigate('LOL Booking History'); // Navigate to LOL More screen after publishing
      };
...
<View style={styles.dateInput}>
  ...
  <TouchableOpacity onPress={showCheckOutDatepicker}>
    <Text style={styles.input}>
      {checkoutdate ? checkoutdate.toLocaleTimeString() : 'Select Time'}
    </Text>
  </TouchableOpacity>
  {showCheckOutPicker && (
    <DateTimePicker
