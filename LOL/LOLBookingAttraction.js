...
const LOLAttractionBookingScreen = () => {
  ...
  const handlebooking = async () => {
    ...
    if (!selectedAttraction || !place || !checkindate || !checkoutdate || !adults ) {
      ...
      try {
        ...
        userQuerySnapshot.forEach((doc) => {
          ...
          if (userData.username === selectedAttraction) {
        ...
        const bookData = {
          category: 'Attraction',
          businessname: selectedAttraction,
...
export default LOLAttractionBookingScreen;
