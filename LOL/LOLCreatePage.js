...
const LOLCreateMainScreen = () => {
  ...
  useEffect(() => {
    ...
    const handlePost = () => {
        navigation.navigate('LOL Create Post');
    }
    const handleReview = () => {
        navigation.navigate('LOL Create Review');
    }
    const handleTrail = () => {
        navigation.navigate('LOL Create Trail');
    }
        ...
        <View style={styles.container}>
          <View style={styles.logoheader}>
            ...
            <View style={styles.midContainer}>
              ...
              <Text style={styles.selectText}>What's on your mind?</Text>
                <Text style={styles.OtherselectText}>What would you want to create today?</Text>

             
                <TouchableOpacity onPress={() => handlePost()} style={[styles.curvedContainer]}>        
                <View>
                    <Image
                    source={require('../assets/post.jpg')}
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Post</Text>
                </View>
                </TouchableOpacity>

                <TouchableOpacity onPress={() => handleReview()} style={[styles.curvedContainer]}>       
                <View>
                    <Image
                    source={require('../assets/review.jpg')}
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Review</Text>
                </View>
                </TouchableOpacity>

                <TouchableOpacity onPress={() => handleTrail()} style={[styles.curvedContainer]}>           
                <View>
                    <Image
                    source={require('../assets/trails.jpg')}
                    style={styles.image}
                    />
                    <Text style={styles.textBehindImage}>Trail</Text>
                </View>
                </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    image: {
      ...
      textBehindImage: {
        ...
        textAlign: 'center',
        width: '100%',
        marginTop: 65, // Adjust the positioning of the text as needed
      },
    selectText: {
        color: '#0A2753',
        fontSize: 32,
...
export default LOLCreateMainScreen;