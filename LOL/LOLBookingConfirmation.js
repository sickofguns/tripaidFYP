...
const LOLBookingConfirmationScreen = () => {
  ...
  useEffect(() => {
    ...
    const handleProceed = () => {
        navigation.navigate('LOL Booking History'); // Navigate to SignUp screen on button press
    };
...
export default LOLBookingConfirmationScreen;