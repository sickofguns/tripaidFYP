...
const LOLMoreScreen = () => {
  ...
  useEffect(() => {
    ...
    const iconData = [
        ...
        { icon: "event", label: "Bookings", onPress: () => navigation.navigate('LOL Booking History') },
        { icon: "assignment", label: "Itinerary", onPress: () => navigation.navigate('LOL Itinerary') },
        { icon: "insights", label: "Insights", onPress: () => navigation.navigate('LOL Insights') },
        { icon: "business", label: "Business Affiliate Page", onPress: () => navigation.navigate('Business Affiliate Page') },
        ...
        { icon: "apps", label: "Sign-in with Socials", onPress: () => navigation.navigate('Socials') },
      ];
