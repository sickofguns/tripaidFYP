...
const LOLMainBookingScreen = () => {
  ...
  const handlePressTransport = () => {
    navigation.navigate("LOL Booking Page - Transport"); // Navigate to SignUp screen on button press
  };

  const handlePressLifestyle = () => {
    navigation.navigate("LOL Booking Page - Lifestyle"); // Navigate to SignUp screen on button press
  };
  
  const handlePressTours = () => {
    navigation.navigate("LOL Booking Page - Tours"); // Navigate to SignUp screen on button press
  };

  const handlePressEvents = () => {
    navigation.navigate("LOL Booking Page - Events"); // Navigate to SignUp screen on button press
  };
